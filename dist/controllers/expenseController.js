...
const getExpenseCategorySummaryRow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenseByCategorySummaryRow = yield Summaries_1.ExpenseByCategory.find().sort({
            date: -1,
        });
        const expenseByCategorySummary = expenseByCategorySummaryRow.map((item) => (Object.assign(Object.assign({}, item.toObject()), { amount: item.amount.toString() })));
